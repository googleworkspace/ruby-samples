...
APPLICATION_NAME = 'Google Enterprise License Manager API Ruby Quickstart'.freeze
CLIENT_SECRETS_PATH = 'client_secrets.json'.freeze
CREDENTIALS_PATH = 'token.yaml'.freeze
SCOPE = Google::Apis::LicensingV1::AUTH_APPS_LICENSING
...
response = service.list_license_assignments_for_product(product_id,
                                                        customer_id,
                                                        max_results: 10)
